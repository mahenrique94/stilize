...
class Media implements Component {
    ...
    public play(media : HTMLObjectElement) : void {
        ...
        let sources : HTMLObjectElement = media.getElementsByClassName('c-media__source');        
    ...
    private _start(player : HTMLObjectElement, source : HTMLObjectElement) : void {
        let traveled : HTMLObjectElement = player.parentNode.getElementsByClassName('c-media__traveled')[0];
        let duration : HTMLObjectElement = player.parentNode.getElementsByClassName('c-media__duration')[0];
        let current : HTMLObjectElement = player.parentNode.getElementsByClassName('c-media__current')[0];
