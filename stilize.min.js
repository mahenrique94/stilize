...
var Loading = (function () {
    ...
    Loading.prototype.new = function () {
        return this._create();
    };
    Loading.prototype._create = function () {
        var loading = document.createElement("div");
        loading.classList.add("o-loading", "js-o-loading");
        loading.appendChild(this._createIcon());
        return loading;
    };
    Loading.prototype._createIcon = function () {
...
var LoadingController = (function () {
    ...
    LoadingController.prototype.insertInBody = function () {
        document.body.appendChild(this._loading.new());
    };
    LoadingController.prototype.removeLoading = function () {
        var loading = document.querySelector(".js-o-loading");
        if (loading)
            loading.remove();
    };
