...
var Mark = (function () {
    ...
    Mark.prototype._toggle = function (mark) {
        var data = mark.parentNode.querySelector('input');
...
var marks = document.querySelectorAll('.o-mark__data');
marks.forEach(function (mark) {
    if (mark.checked) {
        var element = mark.parentNode.querySelector('.o-mark__element');
