...
var Dialog = (function () {
    ...
    Dialog.prototype.build = function (callback, message, icon) {
...
var DialogController = (function () {
    ...
    DialogController.prototype.build = function (event, callback, message, icon) {
        if (message === void 0) { message = "Deseja confirmar a operação"; }
    ...
    DialogController.prototype.execute = function (callback) {
        callback();
        this.close();
    };
