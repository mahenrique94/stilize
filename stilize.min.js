...
var ObjectHelper = (function () {
    ...
    ObjectHelper.isNull = function (obj) {
        return obj == null;
    };
    return ObjectHelper;
}());
...
var DialogController = (function () {
    ...
    DialogController.prototype.execute = function () {
        ...
        this._callback.apply(this, [this._invoker].concat(this._parameters));
        this.close();
    };
...
var Mark = (function () {
    ...
    Mark.prototype.mark = function (mark) {
        var data = mark.parentNode.parentNode.querySelector("input[type=hidden], .is-hidden");
    ...
    Mark.prototype._dispatchInputEvent = function (mark) {
...
if (marks.length > 0) {
    marks.forEach(function (mark) {
        ...
        if (mark.checked) {
            var children = mark.parentNode.querySelectorAll(".o-mark__element");
...
var Processing = (function () {
    ...
    Processing.prototype.destroy = function () {
        var processing = document.querySelector(".js-o-processing");
        if (processing)
            processing.remove();
    };
    Processing.prototype.new = function (message) {
        return this._create(message);
    };
    Processing.prototype._create = function (message) {
    ...
    Processing.prototype._createIcon = function () {
        var icon = document.createElement("i");
        icon.classList.add("o-processing__icon", "icon-spin1", "animate-spin");
        return icon;
    };
    Processing.prototype._createMessage = function (message) {
...
var ProcessingController = (function () {
    ...
    ProcessingController.prototype.start = function (message) {
